function createTechersPage(teachersCards) {
  ...
  <div class="container">
    ...
    <div class="text-center">
      <a href="#" class="mx-auto text-primary" id="addTeacherBtn" data-bs-toggle="modal" data-bs-target="#teachersForm" style="font-size: 4rem;"><i class="bi bi-plus-circle"></i></a>
